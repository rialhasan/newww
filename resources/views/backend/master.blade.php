...
<html lang="en">
   ...
   <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
    <a class="dropdown-item icon-key m-r-xs" href="{{ route('logout') }}"
            ...
            <div class="page-sidebar sidebar">
                <div class="page-sidebar-inner slimscroll">
                    <ul class="menu accordion-menu">
                        <li class= "@yield('dash')"><a href="{{route('home') }}" class="waves-effect waves-button"><span class="menu-icon icon-home"></span><p>Dashboard</p><span class="active-page"></span></a></li>
                        ...
                        <!-- {{--Category start--}} -->
                        <li class="droplink @yield('act')"><a href="#" class="waves-effect waves-button"><span class="menu-icon icon-envelope-open"></span><p>Category</p><span class="arrow"></span></a>
                            <ul class="sub-menu">
                                <li><a href="{{route('categoryform')}}"><i class='fa fa-plus'></i>Add</a></li>
                                <li><a href="{{route('categoryview')}}"><i class='fa fa-eye'></i>Read</a></li>
                                <li><a href="{{route('categoryTrash') }}"><i class='fa fa-trash'></i>Trash</a></li>
                            </ul>
                        </li>
                        <!-- {{--Category end--}} -->

                        <!-- {{--Sub Category start--}} -->
                        <li class="droplink @yield('subcategory')"><a href="#" class="waves-effect waves-button"><span class="menu-icon icon-envelope-open"></span><p>Sub  Category</p><span class="arrow"></span></a>
                            <ul class="sub-menu">
                                <li><a href="{{route('SubCategory')}}"><i class='fa fa-plus'></i>Add</a></li>
                                <li><a href="{{route('SubCategoryView') }}"><i class='fa fa-eye'></i>Read</a></li>
                                <li><a href="#"><i class='fa fa-trash'></i>Trash</a></li>
                            </ul>
                        </li>
                        <!-- {{--Sub Category end--}} -->
                        ...
                        <!-- {{--Color start--}} -->
                        <li class="droplink @yield('color')"><a href="#" class="waves-effect waves-button"><span class="menu-icon icon-envelope-open"></span><p>Color</p><span class="arrow"></span></a>
                            <ul class="sub-menu">
                                <li><a href="{{route('color')}}"><i class='fa fa-plus'></i>Add</a></li>
                                <li><a href="#"><i class='fa fa-eye'></i>Read</a></li>
                                <li><a href="#"><i class='fa fa-trash'></i>Trash</a></li>
                            </ul>
                        </li>
                        <!-- {{--Color end--}} -->
                        ...
                        <!-- {{--Size start--}} -->
                        <li class="droplink @yield('size')"><a href="#" class="waves-effect waves-button"><span class="menu-icon icon-envelope-open"></span><p>Size</p><span class="arrow"></span></a>
                            <ul class="sub-menu">
