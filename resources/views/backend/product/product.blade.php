            ...
            <div class="col-md-8 col-md-offset-2">
                <div class="panel panel-white">
                    ...
                    <div class="panel-body">
                        <form action="{{route('productPost')}}" files=true enctype="multipart/form-data"  class="form-horizontal m-t-xs" method="post"
                            >
                            @csrf
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="product_summary" class="form-control" id="product_summary"
                            ...
                            <div class="form-group">
                                <label for="product_description" class="col-sm-4 control-label">Product
                                    Description</label>
                                <div class="col-sm-10">
                                    <textarea name="product_description" id="product_description" class="from-control"
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <select multiple name="product_color" id="product_color" class="from-control"
                                        style='width:100%'>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <select name="subcategory_id" id="subcategory_id" class="from-control select2"
                                        style='width:100%'>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="product_alart" class="form-control" id="product_alart"
                                        placeholder="Product Alart">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" value="{{ $unique_code}}" readonly name="product_code"
